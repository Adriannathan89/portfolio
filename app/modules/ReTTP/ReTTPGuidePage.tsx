...
export function ReTTPGuidePage() {
  ...
  return <main className="rettp-page rettp-guide-page"><ScrollEffects />
    <aside className="rettp-docs-sidebar" aria-label="Guide table of contents"><Link className="rettp-docs-back" to="/rettp">← Release</Link><p>ReTTP DOCUMENTATION</p><b>DSL guide</b><GuideLinks activeSection={activeSection} /><hr /><span>v0.1.0</span></aside>
    ...
    <footer className="rettp-footer section-shell"><Link to="/rettp">← Back to ReTTP release</Link><span>ReTTP DSL guide · v0.1.0</span></footer>
  </main>;
}
